...
- **Claim-owned durable root:** `docs/production/evidence/PLAY-076/currente6d3`; the accepted V6 receipt is preserved byte-for-byte as `QA-PASS.json` with SHA-256 `cf3c828283335f9483cafd42b0667ab8448aa1d2f6d019c9b0f8716e692ec846`.
...
- **Status:** `accepted` — exact product `e6d359c6306d26aeb0e4d0b6af2836064e710bb5` received `APPROVE_PLAY076_DAY1_DAY11`; Day 1 and Day 11 passed regular and exact 900×600 presentation, and PID `20098` remains running and paused at Day 11 / tick 41. No release or push is claimed.
