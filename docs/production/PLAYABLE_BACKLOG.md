...
- **Current disposition:** Offline calibration v02 is durably preserved at world-art commit `fda4a15ead47b37f3610e4b3d7f07bb7ff102d8a` and passes its technical determinism/uniqueness checks, but independent playtest-quality review rejected the art at 18/28. North and west read as roof ornamentation rather than grounded road-facing entrances at native-2x; the dark institutional mass, oversized pale roof, compressed grayscale facade hierarchy, and ambiguous final edge proof also fail the binding art/readability gate. The lane may author only a third residential four-view calibration revision. The remaining 44 sources, production selection, and renderer ingestion remain unauthorized.
