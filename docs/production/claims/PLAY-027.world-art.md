...
- **Status:** Active. Residential L1–L4, Commercial L1–L4, Industrial L1, and Industrial L2 have accepted source and shipping outcomes. Industrial L3 source authority is complete; replacement-R2 renderer ingestion is active and production selection remains pending staged and independent QA. Industrial L4 exact v17 architecture remains the strongest North candidate, but its A-only raw `526d7c410491f11367ebf013236d281da0b60887` is rejected for a pipeline-created near-chroma edge.
- **Latest L4 disposition:** V16 and v17 contain the same 1,807 contaminated coordinates, proving the defect is invariant across the architecture repair and originates in the opaque-magenta/contact-shadow/partial-alpha compositor boundary. Integration authorizes only the two-run no-Metal matte-attribution diagnostic under `docs/production/evidence/PLAY-027/INDUSTRIAL-L04-V17-RAW-RETURN-AND-MATTE-DIAGNOSTIC-AUTHORITY.md`. No further modeling, raw process, B/C, siblings, normalization authority, ingestion, shipping, or production selection is authorized.
