#!/usr/bin/env python3
"""Pure-data South v13 compatibility and lowering proof.
...
PACKET = ROOT / "v13-compatibility-v01"
SCENE_PATH = PACKET / "SCENE.json"
MATERIALS_PATH = PACKET / "MATERIALS.json"
...
RESULT_RELATIVE_PATH = (
    ...
    "v13-compatibility-v01/V13-COMPATIBILITY-RESULT.json"
)
SOURCE_ROOT = "Native/CitySimNative/WorldArt/Blender/PLAY-080/industrial-l04-south-source-v01"
EVIDENCE_ROOT = "docs/production/evidence/PLAY-080/industrial-l04-south-source-v01/v13-compatibility-v01"
NON_ALIAS_PROOF = {
    "sourceKey": "industrial-l04/variant-0/south/blender-art-v13-south-compatibility",
    "viewDirection": "south",
...
EXPECTED_SCENE_IDENTITY = {
    "schema": "citysim.world-art.blender-compatibility-design.v13",
    "task": "PLAY-080",
    "logicalBuildingID": "industrial-l04",
    "variant": "variant-0",
...
EXPECTED_PUBLISHED_SEMANTIC_INPUTS = [
    "docs/production/evidence/PLAY-027/industrial-l04/l04/blender-north-art-v13/design-authority-v01/DESIGN-AUTHORITY.json",
    "Native/CitySimNative/WorldArt/Blender/PLAY-027/industrial-l04-north-art-v13/DESIGN-MATERIALS.json",
...
EXPECTED_RAW_GEOMETRY_SIGNATURES = {
    ...
    "south-staff-entry": "6273d46559d4843264d017960cd7f480ce9609bc09e2d60beb42dff5c6f1cb03",
    ...
    "south-freight-beat-a": "6f43ff22eb96f696e80087123bdec259ce4d887ef342d1c418a495d14aa67787",
    "south-freight-beat-b": "b25ed8444677f1698387be91ff8425e29f0db8f57ee9851209003b5e649a7d87",
    "south-freight-beat-c": "7603827626af4c888405047b7e49743e10f3764ef9ce2e1354425ae06c8ed7a7",
    ...
    "south-crown-high": "94ee5f3008e8c8c32d950394a7712a36e261ead7797a74e4b6ded98ca9ab5b2f",
...
EXPECTED_RAW_GEOMETRY_SET_SHA256 = "f428a4494c97a1ff530c649e771357f038e7a88329f7071d0d679c1467701348"
...
def validate_owned_path(path: str) -> None:
    ...
    if not (path == EVIDENCE_ROOT or path.startswith(EVIDENCE_ROOT + "/")):
        raise ValueError("path escapes South v13 evidence root")
...
def validate_exact_authority_bindings(scene: dict, materials: dict) -> tuple[list[str], dict]:
    ...
    if authorship.get("method") != "independent-south-semantic-compatibility-design":
...
def validate_packet(scene: dict, materials: dict, evidence_path: str = RESULT_RELATIVE_PATH, mapping: dict | None = None) -> dict:
    ...
    if scene.get("sourceKey") != "industrial-l04/variant-0/south/blender-art-v13-south-compatibility":
...
class SouthV13CompatibilityTests(unittest.TestCase):
    @classmethod
    ...
    def test_direction_identity_and_no_render_authority(self) -> None:
        ...
        self.assertEqual("industrial-l04/variant-0/south/blender-art-v13-south-compatibility", self.scene["sourceKey"])
    ...
    def test_result_binds_repair_route_and_claim_revision(self) -> None:
        result = load(ROOT.parents[5] / RESULT_RELATIVE_PATH)
        self.assertEqual("quality-v1:south-v13-frontier-recovery-r2", result["route"]["routeId"])
        self.assertEqual("b1c5dc8c8d89b468f1cc8cc30eda46b87e90e4f4455778f7a442a5479c7873d0", result["route"]["routeSha256"])
        self.assertEqual("567aa6f0bc2ffc984caaf80f22f738154e5751664c21939f0289b15dcbea5cc5", result["route"]["receiptSha256"])
        self.assertEqual(8, result["claim"]["revision"])
        self.assertEqual("87d5cbd7701de2267d65c512ebeed01eafcba74f", result["candidateProjection"]["observedHead"])
        self.assertEqual("87d5cbd7701de2267d65c512ebeed01eafcba74f", result["candidateProjection"]["requiredDirectParent"])
