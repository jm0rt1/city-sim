...
enum IndustrialL2EastV04ProbeError: Error, CustomStringConvertible {
    ...
    var description: String {
        switch self {
        case .arguments:
            return "usage: render-industrial-l2-east-v04-primary-probe --repository-root <path> --output-root <path> --renderer-source-commit <sha>"
...
enum RenderIndustrialL2EastV04PrimaryProbeMain {
    static func main() throws {
        ...
        guard
            ...
            throw IndustrialL2EastV04ProbeError.invalid(
                "v04 authority, output path, or one-process boundary failed"
            )
        }
        ...
        let outputs: [(String, CGImage, String)] = [
            (
                "raw.png",
                governedRaw,
                "governed-v04-straight-alpha-flat-chroma-quantized-canonicalized-raw"
            ),
            (
        ...
        let toolURL = root.appendingPathComponent(
            "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/Tools/RenderIndustrialL2EastV04PrimaryProbe.swift"
        )
        ...
        let provenance: [String: Any] = [
            "schema": 1,
            "task": "PLAY-027",
            "type": "industrial-l02-east-v04-single-primary-raw-probe",
            "disposition": "PENDING_RAW_REVIEW",
            "approvedPrepixelCommit": v04ProbeApprovedCommit,
            "rendererSourceCommit": sourceCommit,
            "sourceKey":
                "industrial_l02/variant-0/east/projection-silhouette-reset-art-proof-v04",
        ...
        print("PLAY-027 Industrial L2 East v04 primary emitted")
        print(
