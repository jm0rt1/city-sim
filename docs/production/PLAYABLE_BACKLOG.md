...
- **Latest L4 gate:** CONTRACT-019 R5 reached `HARD_PIPELINE_LIMIT`: the final bounded SceneKit depth rule still produced 195 differing pixels/346 channels and was rolled back. SceneKit is closed for new source authority. CONTRACT-020 authorizes one North-only Blender 4.5.12 LTS / single-thread Cycles CPU transfer calibration of exact v18 geometry and registration. Portal redesign, siblings, normalization, R3 ingestion, shipping, and production selection remain blocked until the DCC pipeline passes three-process decoded identity plus independent Renderer and QA review.
