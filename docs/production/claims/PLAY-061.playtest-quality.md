...
- **Title:** Gate the directional commercial skyline
...
level/direction identities load from the exact staged bundle, face the
authoritative road, remain distinct from Residential and one another, and
materially improve the skyline in both regular and compact play.

The exact candidate must score at least 19/20 with 4/4 for Commercial identity
and direction and 4/4 for world/HUD cohesion; no category may fall below 3.
Any alias, fallback, wrong frontage, runtime transform, overlap, ground-contact
error, stale interaction target, unbounded resource growth, P0/P1, or candidate
ambiguity automatically rejects.

Do not repair product, coach journeys, substitute fixtures or candidates, crop
away defects, reuse author scoring, push, integrate, self-accept, or pin.
