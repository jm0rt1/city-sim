...
a legible consequence/recovery history while preserving a meaningful warned
setback and Regional Capital standards.

Do not touch SpriteKit, SwiftUI composition, commands, packages, build scripts,
legacy Python, or art selection. Do not add renderer-only state or weaken the
second act to manufacture density. Commit product/tests, staged evidence, and
completion separately. Do not push, integrate, self-score, self-accept, or pin.
