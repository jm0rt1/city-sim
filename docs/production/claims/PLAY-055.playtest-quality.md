...
- **Title:** Gate the directional skyline and readable HUD
...
author evidence from independent observations, retain failed attempts, and
bind every claim to the exact staged app, process, window, state, and resource
hashes.

Residential direction/level identity and HUD legibility are mandatory 4/4
categories. The overall combined threshold is at least 19/20 with zero P0/P1,
zero automatic reject, and explicit material preference in both regular and
compact same-state comparisons. Commercial and Industrial breadth remain
outside this gate and cannot be used to dilute or inflate the Residential
score.

Do not coach journeys, substitute fixtures or candidates, crop away defects,
reuse author scoring as independent evidence, push, integrate, mutate product,
self-accept, or pin the thread.
