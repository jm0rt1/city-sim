...
_TERRAIN_SPRITES: dict[str, tuple[int, int, int]] = {
    ...
    "terrain_water_1":   ( 80, 145, 250),
    "terrain_water_2":   ( 95, 158, 255),
    "terrain_water_3":   ( 55, 120, 235),
    # Road network tiles
    "road_dot":          ( 90,  90,  90),
    "road_h":            (110, 110, 110),
    "road_v":            (100, 100, 100),
    ...
    "road_end_s":        ( 95,  95,  95),
    "road_end_w":        ( 95,  95,  95),
    # Vehicle sprites (4-frame strips per direction)
    "vehicle_car_n_0":   (220,  50,  50),
    "vehicle_car_n_1":   (200,  40,  40),
    "vehicle_car_n_2":   (180,  30,  30),
    "vehicle_car_n_3":   (160,  20,  20),
    "vehicle_car_e_0":   ( 50, 220,  50),
    "vehicle_car_e_1":   ( 40, 200,  40),
    "vehicle_car_e_2":   ( 30, 180,  30),
    "vehicle_car_e_3":   ( 20, 160,  20),
    "vehicle_car_s_0":   ( 50,  50, 220),
    "vehicle_car_s_1":   ( 40,  40, 200),
    "vehicle_car_s_2":   ( 30,  30, 180),
    "vehicle_car_s_3":   ( 20,  20, 160),
    "vehicle_car_w_0":   (220, 220,  50),
    "vehicle_car_w_1":   (200, 200,  40),
    "vehicle_car_w_2":   (180, 180,  30),
    "vehicle_car_w_3":   (160, 160,  20),
}
...
_HEIGHT_TILES: dict[str, int] = {
    ...
    "road_end_s":        1,
    "road_end_w":        1,
    # Water animation frames — always 1
    "terrain_water_1":   1,
    "terrain_water_2":   1,
    "terrain_water_3":   1,
    # Vehicle sprites — always 1
    "vehicle_car_n_0":   1,
    "vehicle_car_n_1":   1,
    "vehicle_car_n_2":   1,
    "vehicle_car_n_3":   1,
