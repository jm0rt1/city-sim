...
- **Current disposition:** Residential L1–L4, Commercial L1–L4, Industrial L1, and Industrial L2 have accepted source and shipping outcomes. Industrial L3 cohesion source candidate `0aefb804c59b4ff9b919dc81fdca907cd4b85c5e`, metadata repair `5b1378a2c81d7d55a39b19366b5206c28f70d9f7`, and repaired manifest `78fef5beed40229d0637ba74e85737c939bbaa460f42a17b49f24769e92704a1` are accepted source authority; replacement-R2 renderer ingestion is active and production selection remains pending staged and independent QA. Industrial L4 version 01, analytic version 02, Turbine v03, material v06, and descriptor-bound v07 remain preserved and rejected. The selected Turbine Works clay massing is integrated at `90f3c0e8d3c6eab62de2487b84ebf211a2403cd6`. Exact v08 pre-pixel candidate `58bdac23653389ad62603f9e2567bd65430fd7ed` passed independent QA and renderer review with descriptor-derived N/E/S/W proof, exact registration, readable freight/staff semantics, and two-run identity. Integration authorizes only its North three-process raw-source gate under `docs/production/evidence/PLAY-027/INDUSTRIAL-L04-TURBINE-V08-PREPIXEL-ACCEPTANCE-58bdac2.md`; its exact North descriptor now has a fail-closed offline resolver admission under `docs/production/evidence/PLAY-027/INDUSTRIAL-L04-TURBINE-V08-NORTH-RESOLVER-AUTHORITY.md`. East, South, West, normalization, R3 ingestion, and production selection remain unauthorized pending independent North raw review.
- **Latest L4 gate:** The exact North v08 raw triplet is deterministic but visually rejected because its four roof volumes collapse into one generic gable in literal source/native/192 color and grayscale. The retained packet is `docs/production/evidence/PLAY-027/industrial-l04/l04/turbine-v08-north-raw-v02/`. A North-only v09 pre-pixel roof/value redesign is active under stricter raster-visible cadence, luma, slope, staff-entry, footprint, registration, and atlas gates; no additional raw or sibling work is authorized yet.
