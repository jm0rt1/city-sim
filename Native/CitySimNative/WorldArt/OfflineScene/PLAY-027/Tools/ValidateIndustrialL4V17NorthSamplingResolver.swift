...
enum IndustrialL4V17NorthSamplingResolverError:
    Error, CustomStringConvertible
{
    ...
    var description: String {
        ...
        case .arguments:
            return """
            usage: validate-industrial-l4-v17-north-sampling-resolver \
...
private let descriptorPath =
    ...
    + "art-proof/industrial-l04-crucible-gantry-v17-north-prepixel/artifact/scenes/"
...
private let materialPath =
    "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/"
    + "art-proof/industrial-l04-crucible-gantry-v17-north-prepixel/materials/"
...
private let geometryID = "industrial-l04-crucible-gantry-v17-north-monumental-portal"
...
private func argument(_ name: String, in arguments: [String]) throws -> String {
    guard
        ...
        throw IndustrialL4V17NorthSamplingResolverError.arguments
    }
...
private func object(_ data: Data) throws -> [String: Any] {
    guard
        ...
        throw IndustrialL4V17NorthSamplingResolverError.invalid(
...
@main
enum ValidateIndustrialL4V17NorthSamplingResolverMain {
    static func main() throws {
        ...
        let report: [String: Any] = [
            ...
            "task": "PLAY-027",
            "scope":
                "hash-and-material-bound Industrial L4 source-v17-prepixel "
                + "North-only resolver",
