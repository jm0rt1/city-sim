...
enum IndustrialL4HeroPrepixelError: Error, CustomStringConvertible {
    case arguments
    case invalid(String)
    ...
    var description: String {
        switch self {
        case .arguments:
            return "usage: build-industrial-l4-hero-prepixel --repository-root <path> --regular-staged-frame <path> --compact-staged-frame <path> [--output-root <path>]"
...
private func l4Argument(
    ...
    guard let index = arguments.firstIndex(of: name) else {
        if required { throw IndustrialL4HeroPrepixelError.arguments }
        return nil
    }
    guard index + 1 < arguments.count else {
        throw IndustrialL4HeroPrepixelError.arguments
    }
...
private func l4WriteJSON(_ object: Any, to url: URL) throws {
    guard !FileManager.default.fileExists(atPath: url.path) else {
        throw IndustrialL4HeroPrepixelError.invalid(
...
private func l4WritePNG(_ image: CGImage, to url: URL) throws {
    ...
    guard let destination = CGImageDestinationCreateWithURL(
        ...
        throw IndustrialL4HeroPrepixelError.invalid("could not create PNG")
    }
...
private func l4Materials() -> [[String: Any]] {
    [
        ...
        l4Material("l4-warm-glazing", [0.67, 0.42, 0.19, 1], 0.39, 0.08, "warm-staff-entry-glazing"),
        ...
        l4Material("l4-light-trim", [0.68, 0.55, 0.36, 1], 0.72, 0.29, "weathered-copper-bronze-trim"),
...
private func l4Descriptor(
    ...
    [
        ...
        "toolchainFingerprint": [
            ...
            "file": "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/toolchain/toolchain-industrial-l04-source-v02.json",
        ...
        "materialLibrary": [
            ...
            "file": "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/art-proof/industrial-l04-hero-v02/materials/industrial-l04-hero-v02.json",
            "sha256": materialHash,
        ],
...
private func l4Context(width: Int, height: Int) throws -> CGContext {
    guard let context = CGContext(
        ...
        throw IndustrialL4HeroPrepixelError.invalid("could not allocate context")
    }
...
private func l4RasterizeTriangle(
    ...
    guard triangle.count == 3, color.count == 4 else {
        throw IndustrialL4HeroPrepixelError.invalid("invalid triangle input")
    }
    let a = triangle[0]
    let b = triangle[1]
    let c = triangle[2]
...
private func l4Sheet(
    ...
    guard let image = context.makeImage() else {
        throw IndustrialL4HeroPrepixelError.invalid("could not compose sheet")
    }
    return image
}
...
private func l4Resize(
    ...
    guard let resized = context.makeImage() else {
        throw IndustrialL4HeroPrepixelError.invalid("could not resize image")
    }
    return resized
}
...
@main
struct BuildIndustrialL4HeroPrepixel {
    static func main() throws {
        ...
        let toolchainRelative =
            "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/toolchain/toolchain-industrial-l04-source-v02.json"
        let materialRelative =
            "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/art-proof/industrial-l04-hero-v02/materials/industrial-l04-hero-v02.json"
        let sceneBaseRelative =
            "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/art-proof/industrial-l04-hero-v02/scenes/industrial_l04/variant-0"
        let evidenceRelative =
            "docs/production/evidence/PLAY-027/industrial-l04/l04/hero-redesign-v02-prepixel"
        ...
        let materialLibrary: [String: Any] = [
            "schema": 1,
            "task": "PLAY-027",
            "libraryID": "industrial-l04-hero-v02",
