...
- **Title:** Project the fail-closed 43x4 authored-direction source-attempt ledger
- **Lane:** Integration-published GraphOps mechanical evidence
- **Owner task:** `019fec54-216e-7af0-99b8-3d451f36fe26`
- **Branch:** `codex/citysim-world-art-ledger-game012a-current7a`
...
- **Required row fields:** identity, family, level, variant, direction, owner/claim/ref,
  ...
  source admission, renderer quarantine, runtime activation, production selection,
  contradictions, and deterministic next owner/action.
- **Boundaries:** Commercial `l01_v00` remains terminal/no-retry; all South rows remain
  not admitted; Industrial v01/v02 remains unresolved; East magenta/purple, West
  two-failure, North blocked, and physical 44 versus logical 43 remain explicit
