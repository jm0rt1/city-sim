...
private func authoredParts() -> [Part] {
    var parts: [Part] = [
        ...
        part("v14-hall-roof", "roof", "v14-dark-roof-steel",
             [-15, 20, 5], [28, 3, 44]),
        part("v14-clerestory-base", "clerestory", "v14-structural-mid-steel",
             [-15, 22.5, 7], [20, 2, 30]),
        ...
        part("v14-staff-entry", "staffEntry", "v14-warm-glazing",
             [-20, 5.7, -27.2], [7, 8, 1.6]),
        part("v14-staff-header", "staffSurround", "v14-concrete-trim",
             [-20, 10.5, -26.8], [10, 2, 2.4]),
        part("v14-staff-post-west", "staffSurround", "v14-concrete-trim",
             [-24.4, 6, -26.8], [1.2, 8, 2.4]),
        part("v14-staff-post-east", "staffSurround", "v14-concrete-trim",
             [-15.6, 6, -26.8], [1.2, 8, 2.4]),
    ...
    parts += [
        ...
        part("v14-lift-rail", "gantryLift", "v14-process-heat",
             [13, 23, -5], [1.2, 8, 1.2]),
        part("v14-gantry-west-mid-brace", "gantryBrace",
             "v14-structural-mid-steel", [0, 17, -5], [6, 2.5, 11]),
        part("v14-gantry-east-mid-brace", "gantryBrace",
             "v14-structural-mid-steel", [26, 17, -5], [6, 2.5, 11]),
        part("v14-girder-front-lower-flange", "gantryFlange",
             "v14-structural-mid-steel", [13, 29.5, -10], [36, 1.4, 5]),
        part("v14-girder-rear-lower-flange", "gantryFlange",
             "v14-structural-mid-steel", [13, 29.5, 0], [36, 1.4, 5]),
    ]
    ...
    let bayCenters = [2.0, 10.5, 19.0]
    for (index, x) in bayCenters.enumerated() {
        let n = index + 1
        parts += [
            part("v14-freight-\(n)-recess", "freight\(n)",
                 "v14-deep-freight-recess", [x, 8, -24.5], [7, 12, 2]),
            part("v14-freight-\(n)-header", "freightHeader",
                 "v14-structural-mid-steel", [x, 15, -23], [8.2, 3, 4]),
            part("v14-freight-\(n)-left-post", "freightPost",
                 "v14-dark-gantry-steel", [x - 4.2, 8.5, -23], [1.4, 14, 4]),
            part("v14-freight-\(n)-right-post", "freightPost",
                 "v14-dark-gantry-steel", [x + 4.2, 8.5, -23], [1.4, 14, 4]),
            part("v14-freight-\(n)-heat-strip", "freightHeader",
                 "v14-process-heat", [x, 12.5, -25.6], [4.5, 1, 0.8]),
            part("v14-freight-\(n)-rail", "serviceRail",
                 "v14-structural-mid-steel", [x, 2.5, -25], [1, 1, 6]),
        ]
    }
    ...
    parts += [
        part("v14-hall-cornice", "hallTrim", "v14-concrete-trim",
             [-15, 17.5, -16], [26, 2, 2]),
        part("v14-hall-window-1", "hallWindows", "v14-warm-glazing",
             [-24, 13, -16.2], [3.2, 7, 1.4]),
        part("v14-hall-window-2", "hallWindows", "v14-warm-glazing",
             [-18, 13, -16.2], [3.2, 7, 1.4]),
        part("v14-hall-window-3", "hallWindows", "v14-warm-glazing",
             [-12, 13, -16.2], [3.2, 7, 1.4]),
        part("v14-hall-window-4", "hallWindows", "v14-warm-glazing",
             [-6, 13, -16.2], [3.2, 7, 1.4]),
        part("v14-clerestory-window-1", "clerestoryWindow",
             "v14-warm-glazing", [-1.2, 23, -4], [1.4, 3, 4]),
        part("v14-clerestory-window-2", "clerestoryWindow",
             "v14-warm-glazing", [-1.2, 23, 2], [1.4, 3, 4]),
        part("v14-clerestory-window-3", "clerestoryWindow",
             "v14-warm-glazing", [-1.2, 23, 8], [1.4, 3, 4]),
        part("v14-clerestory-window-4", "clerestoryWindow",
             "v14-warm-glazing", [-1.2, 23, 14], [1.4, 3, 4]),
        part("v14-clerestory-window-5", "clerestoryWindow",
             "v14-warm-glazing", [-1.2, 23, 20], [1.4, 3, 4]),
        part("v14-hall-buttress-1", "hallButtress", "v14-concrete-trim",
             [-25, 9, -16.5], [2, 16, 2]),
        part("v14-hall-buttress-2", "hallButtress", "v14-concrete-trim",
             [-15, 9, -16.5], [2, 16, 2]),
        part("v14-hall-buttress-3", "hallButtress", "v14-concrete-trim",
             [-5, 9, -16.5], [2, 16, 2]),
...
private let palette: [String: [Double]] = [
    ...
    "v14-dark-gantry-steel": [0.13, 0.19, 0.20, 1],
    "v14-structural-mid-steel": [0.24, 0.31, 0.30, 1],
    "v14-oxidized-copper": [0.28, 0.56, 0.51, 1],
