...
- **Title:** Prove the visible-city state matrix
...
truth; do not create a second visual model or persisted presentation state.

Do not alter gameplay outcomes, save schema, fingerprint version, renderer,
SwiftUI, commands, packages, or legacy Python. Stop on unexplained digest
drift, regenerated legacy bytes, or any proposed shared contract expansion.
Do not push, integrate, self-score, self-accept, or pin.
