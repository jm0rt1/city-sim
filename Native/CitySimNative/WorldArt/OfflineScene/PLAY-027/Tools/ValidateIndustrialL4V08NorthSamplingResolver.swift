...
enum IndustrialL4V08NorthSamplingResolverError:
    Error, CustomStringConvertible
{
    ...
    var description: String {
        ...
        case .arguments:
            return """
            usage: validate-industrial-l4-v08-north-sampling-resolver \
...
private let materialPath =
    "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/"
    + "art-proof/industrial-l04-turbine-v08-prepixel/materials/"
...
private let geometryID = "industrial-l04-turbine-v08-n-independent"
...
private func argument(_ name: String, in arguments: [String]) throws -> String {
    guard
        ...
        throw IndustrialL4V08NorthSamplingResolverError.arguments
    }
...
private func object(_ data: Data) throws -> [String: Any] {
    guard
        ...
        throw IndustrialL4V08NorthSamplingResolverError.invalid(
...
@main
enum ValidateIndustrialL4V08NorthSamplingResolverMain {
    static func main() throws {
        ...
        let report: [String: Any] = [
            ...
            "task": "PLAY-027",
            "scope":
                "hash-and-material-bound Industrial L4 source-v08-prepixel "
                + "North-only resolver",
