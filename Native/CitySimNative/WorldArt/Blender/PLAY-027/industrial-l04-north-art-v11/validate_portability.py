#!/usr/bin/env python3
"""Validate the self-contained v11 bundle and every task-owned writer class."""
...
MANIFEST_SHA256 = "93a6e4a19c5cbec956a970df9529608d65ffa76f39a249cc0fa4766c8458edc6"
V11_SCENE_SHA256 = "814d9c2c86a740f04622f4ac47718c14d8f92d090fb127d921270e96ef1921c3"
V11_MATERIALS_SHA256 = (
...
def main() -> None:
    ...
    if sha256(source_root / "SCENE.json") != V11_SCENE_SHA256:
        raise RuntimeError("v11 scene hash drift")
    if sha256(source_root / "MATERIALS.json") != V11_MATERIALS_SHA256:
        raise RuntimeError("v11 materials hash drift")

    with tempfile.TemporaryDirectory(
        prefix="play027-v11-portability-",
        dir="/private/tmp",
    ) as temporary:
    ...
    receipt = {
        "schema": 1,
        "task": "PLAY-027",
        "stage": "north-v11-portability-path-proof",
        "authorityCommit": "ce9a8c633dd07148d6439ca42248890a3fa62a01",
        "rejectedParent": "7042f0934903ca54e360725251a96205a347af4e",
        "sceneSHA256": V11_SCENE_SHA256,
        "materialsSHA256": V11_MATERIALS_SHA256,
        ...
        "disposition": "V11_STATIC_PORTABILITY_PREFLIGHT_PASSED",
