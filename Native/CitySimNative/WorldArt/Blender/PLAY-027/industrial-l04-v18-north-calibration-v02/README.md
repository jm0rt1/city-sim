# PLAY-027 Industrial L4 v18 North Blender registration calibration v02
...
The sole rendering change from v01 is the exact landscape-camera conversion:
...
`ortho_scale` is `237.5878601074218`. All other camera, scene, material,
lighting, contact, and Cycles settings remain bound to v01.
...
/Applications/Blender.app/Contents/MacOS/Blender \
  ...
  --python-exit-code 1 \
  --python Native/CitySimNative/WorldArt/Blender/PLAY-027/industrial-l04-v18-north-calibration-v02/render_v18_north.py \
  -- \
  --repository-root "$PWD" \
  --config Native/CitySimNative/WorldArt/Blender/PLAY-027/industrial-l04-v18-north-calibration-v02/CALIBRATION-CONTRACT.json \
