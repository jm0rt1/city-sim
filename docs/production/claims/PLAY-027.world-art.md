...
- **Latest L4 disposition:** Integration accepted the v06 zero-pixel global
  ...
  architecture is accepted from candidate `ea0fe600`. Exactly one North
  process-A appearance source plus deterministic North-only review outputs is
  authorized by
  `INDUSTRIAL-L04-NORTH-V07-PREPIXEL-ACCEPTANCE.md`. Process B/C and all sibling
  pixels remain blocked until Integration independently accepts A and publishes
  the appearance lock.
