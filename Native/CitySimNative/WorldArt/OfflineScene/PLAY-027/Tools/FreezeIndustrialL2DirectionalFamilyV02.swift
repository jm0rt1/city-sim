...
enum IndustrialL2DirectionalFamilyV02Error: Error, CustomStringConvertible {
    case arguments
    case invalid(String)
    ...
    var description: String {
        ...
        case .arguments:
            return """
            usage: freeze-industrial-l2-directional-family-v02 \
...
private let familyV02AuthorityCommit =
    "4918b32f44f4d767203a02421f364e234eeebf10"
private let familyV02PublishedWaveAuthority =
    "bd9dc14d9d4b5f26f5f1dca153725f8ee919438f"
private let familyV02EastAnchorCommit =
    "023407791bbebe81f882dd8c7a4b348b79c22e67"
private let familyV02EastDescriptorSHA256 =
    "482bea0169e9229df437b05ca6f0299046d49bb92e2e9d9ef4f3865df9be5fa0"
private let familyV02EastMaterialsSHA256 =
    "6ab8b19d6d6cf53dc98f77867117569f6cccd104cd886a2dc1788361736404fb"
private let familyV02EastRawSHA256 =
    "a32725fd0ea0436c1f8a13d319c3c66408a7cdf44ff8f2cdb72665839dd685a8"
private let familyV02EastGeometrySHA256 =
    "6c727c4b7053d69578e97c2f73cf3054cd2dda106bf06625e0dac12a356798fb"
private let familyV02OrthographicScale = 79.1959533691406
private let familyV02SourcePixelsPerWorld =
    1024.0 / (2.0 * familyV02OrthographicScale)
private let familyV02Native2xScale = 144.0 / 512.0

private func familyV02Argument(
    _ name: String,
    in arguments: [String],
    required: Bool = true
) throws -> String? {
    guard let index = arguments.firstIndex(of: name) else {
        if required {
            throw IndustrialL2DirectionalFamilyV02Error.arguments
        }
        return nil
    }
...
private func familyV02SHA256(_ data: Data) -> String {
    SHA256.hash(data: data).map {
        String(format: "%02x", $0)
    }.joined()
}

private func familyV02SHA256(_ url: URL) throws -> String {
    familyV02SHA256(try Data(contentsOf: url))
}

private func familyV02LoadObject(_ url: URL) throws -> [String: Any] {
    guard
        let object = try JSONSerialization.jsonObject(
            with: Data(contentsOf: url)
        ) as? [String: Any]
    else {
        throw IndustrialL2DirectionalFamilyV02Error.invalid(
...
private func familyV02WriteJSON(
    _ value: Any,
    to url: URL
) throws {
...
private func familyV02WriteText(
    _ value: String,
    to url: URL
) throws {
    guard !FileManager.default.fileExists(atPath: url.path) else {
...
private func familyV02NorthBlocks() -> [[String: Any]] {
    [
        familyV02Block(
...
private func familyV02NorthProps() -> [[String: Any]] {
    [
        familyV02Prop(
...
private func familyV02SouthBlocks() -> [[String: Any]] {
    [
        familyV02Block(
...
private func familyV02SouthProps() -> [[String: Any]] {
    [
        familyV02Prop(
...
private func familyV02WestBlocks() -> [[String: Any]] {
    [
        familyV02Block(
...
private func familyV02WestProps() -> [[String: Any]] {
    [
        familyV02Prop(
...
private func familyV02Registration(
    _ direction: String,
    base: [String: Any]
) throws -> [String: Any] {
...
private func familyV02Facades(_ direction: String) -> [[String: Any]] {
...
private func familyV02Entrance(_ direction: String) -> [String: Any] {
...
private func familyV02Occlusion(_ direction: String) -> [[String: Any]] {
...
private func familyV02Descriptor(
    direction: String,
    blocks: [[String: Any]],
    props: [[String: Any]],
    ...
    return [
        ...
        "sceneGeometryID":
            "industrial-l02-\(direction)-wide-low-capable-campus-geometry-v02",
        ...
        "eastReviewAnchor": [
            "commit": familyV02EastAnchorCommit,
            "descriptorSHA256": familyV02EastDescriptorSHA256,
            "materialLibrarySHA256": familyV02EastMaterialsSHA256,
            "rawSHA256": familyV02EastRawSHA256,
            "sourceAuthority": false,
            "productionSelected": false,
        ],
        "materialLibrary": [
            "file": materialsPath,
            "sha256": familyV02EastMaterialsSHA256,
        ...
        "sampling": sampling,
        "registration":
            try familyV02Registration(
                direction,
                base: baseRegistration
            ),
        "entrance": familyV02Entrance(direction),
        "facades": familyV02Facades(direction),
        "occlusionExclusions": familyV02Occlusion(direction),
        "prePixelFamilyAuthority": [
            "approvedContinuationCommit": familyV02AuthorityCommit,
            "scope": "Industrial L2 North South West source-v07 only",
...
private func familyV02CanonicalGeometry(
...
private func familyV02PixelInventory(
    repositoryRoot: URL
    ...
    for path in roots {
        ...
        where url.pathExtension.lowercased() == "png" {
            ...
            rows.append("\(relative) \(try familyV02SHA256(url))")
        }
    }
    rows.sort()
    ...
    return (
        rows.count,
        hashes,
        familyV02SHA256(Data(rows.joined(separator: "\n").utf8))
    )
}

@main
enum FreezeIndustrialL2DirectionalFamilyV02Main {
    static func main() throws {
        let arguments = Array(CommandLine.arguments.dropFirst())
        let repositoryRoot = URL(
            fileURLWithPath:
                try familyV02Argument(
                    "--repository-root",
                    in: arguments
                )!
        ).standardizedFileURL
        let canonicalArtPath =
            "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/art-proof/industrial-l02-directional-family-v02"
        let canonicalEvidencePath =
            "docs/production/evidence/PLAY-027/industrial-l02/l02/directional-family-v02"
        ...
        guard
            artOutputRoot.path.contains(
                "industrial-l02-directional-family-v02"
            ),
            evidenceOutputRoot.path.contains(
                "industrial-l02/l02/directional-family-v02"
            ),
        ...
        guard
            try familyV02SHA256(eastDescriptorURL)
                == familyV02EastDescriptorSHA256,
            try familyV02SHA256(materialsURL)
                == familyV02EastMaterialsSHA256,
            try familyV02SHA256(eastRawURL)
                == familyV02EastRawSHA256
        else {
            throw IndustrialL2DirectionalFamilyV02Error.invalid(
                "immutable East v05 anchor drift"
            )
        }
        let eastAnchor = try familyV02LoadObject(eastDescriptorURL)
        let materialsPath =
            "Native/CitySimNative/WorldArt/OfflineScene/PLAY-027/art-proof/industrial-l02-east-calibration-v05/materials/industrial-l02-east-calibration-v05.json"
        let definitions: [
            (
            ...
            ("north", familyV02NorthBlocks(), familyV02NorthProps()),
            ("south", familyV02SouthBlocks(), familyV02SouthProps()),
            ("west", familyV02WestBlocks(), familyV02WestProps()),
        ]
        ...
        for definition in definitions {
            let descriptor = try familyV02Descriptor(
            ...
            try familyV02WriteJSON(descriptor, to: descriptorURL)
            let descriptorHash = try familyV02SHA256(descriptorURL)
            let geometryHash = familyV02SHA256(
                try familyV02CanonicalGeometry(descriptor)
            )
            ...
            let minimumWorld = components.compactMap { component -> Double? in
                ...
                // One axis may be intentionally thin because it attaches a
                // door, recess, canopy, glazing band, or fascia to a facade.
                // The median measures the smaller visible planar extent
                // without encoding a direction-specific axis exception.
                return dimensions.sorted()[1]
            }.min() ?? 0
            let minimumNative =
                minimumWorld
                * familyV02SourcePixelsPerWorld
                * familyV02Native2xScale
            ...
            let passed =
                ...
                && descriptorHash != familyV02EastDescriptorSHA256
                && geometryHash != familyV02EastGeometrySHA256
            ...
            directionRows.append(
                [
                    ...
                    "sceneGeometryID":
                        "industrial-l02-\(definition.direction)-wide-low-capable-campus-geometry-v02",
        ...
        let pixelInventory = try familyV02PixelInventory(
        ...
        let contract: [String: Any] = [
            "schema": 1,
            "task": "PLAY-027",
            "type": "industrial-l02-directional-family-v02-prepixel-contract",
            "approvedContinuationCommit": familyV02AuthorityCommit,
            "publishedWaveAuthority": familyV02PublishedWaveAuthority,
            "rendererIngestionWindow": "Wave 010 R1 — Industrial L2",
            "scope": ["north", "south", "west"],
            "immutableEastReviewAnchor": [
                "commit": familyV02EastAnchorCommit,
                "descriptorSHA256": familyV02EastDescriptorSHA256,
                "canonicalGeometrySHA256": familyV02EastGeometrySHA256,
                "materialLibrarySHA256": familyV02EastMaterialsSHA256,
                "rawSHA256": familyV02EastRawSHA256,
                "sourceAuthority": false,
                "productionSelected": false,
        ...
        let validation: [String: Any] = [
            ...
            "task": "PLAY-027",
            "type":
                "industrial-l02-directional-family-v02-prepixel-validation",
            "passed": allPassed,
        ...
        try familyV02WriteText(
            """
            # PLAY-027 Industrial L2 directional family v02 art direction

            Status: `PREPIXEL_REVIEW_CANDIDATE`

            East v05 remains the immutable governed review anchor. North, South,
            and West are three separately authored source-v07 descriptors. No
        ...
        try familyV02WriteText(
            """
            # PLAY-027 Industrial L2 directional family v02 review request
