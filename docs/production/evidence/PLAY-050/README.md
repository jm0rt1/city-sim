...
The first-wave journey is frozen in [critical-journey-v1.md](critical-journey-v1.md). If an accepted product contract makes a step obsolete, create a new journey version and retain the previous one. Never rewrite a completed or in-progress journey to make a candidate pass.
