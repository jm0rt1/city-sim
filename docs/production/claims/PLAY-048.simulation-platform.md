...
- **Title:** Adopt the believable starter district into runtime trust
- **Lane:** Simulation platform
- **Branch:** `codex/citysim-simulation-platform`
- **Worktree:** `/Users/James/.codex/worktrees/e909/city-sim`
- **Base commit:** Published Wave 006 authority commit containing this claim
...
authentic schema-0/schema-1 bytes and all version identifiers.

Do not change the starter layout, balance, messages, renderer, HUD, commands,
schema, fingerprint version, or authentic legacy inputs. Begin product/test
mutation only after integration sends the exact PLAY-016 checkpoint. Commit
adoption, evidence, and completion separately; do not push, self-integrate,
self-score, or pin the thread.
