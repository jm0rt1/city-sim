...
- **Status:** authorized for the next platform phase after a clean merge of current master
...
authoritative story moments. Keep all generation in test support and fixture
tooling; normal product runtime must not depend on it.

Do not change gameplay rules, authentic legacy bytes, schema or fingerprint
versions, renderer/UI/build scripts, or claim fixture playback as a substitute
for the independent no-coaching session.
