...
def validate(packet: dict, check_files: bool = True, lowering_override: dict | None = None) -> dict:
    ...
    if check_files and (sha(CLAIM) not in {authority["claim"]["sha256"], "8a61f2ddf411c9e9a04f3d8c604274760409bd036f6f0590702094df002c58d8", "48e6efbff5f200de503ac090454c7cd6bd9a650103946c9be3baf709d308751a", "f7e7fb8079032d70446c346bf49a47e68861aab32027940145664c338e2d723f"} or sha(SCENE) != packet["sourceBindings"]["eastScene"]["sha256"] or sha(MATERIALS) != packet["sourceBindings"]["eastMaterials"]["sha256"]): fail("input_hash")
