#!/usr/bin/env python3
"""Build deterministic keyed LODs and family contact sheets for residential_l01_v1."""
...
SOUTH_RAW = REPO / "Native/CitySimNative/WorldArt/ImageGenSingleAngle/PLAY-097/residential/raw/residential_l01_variant_1/source-v01.png"
SOUTH_LODS = {
    lod: REPO / f"Native/CitySimNative/WorldArt/ImageGenSingleAngle/PLAY-097/residential/normalized/residential_l01_variant_1/{lod}/source-v03.png"
...
def build_outputs(output_root: Path) -> dict[str, object]:
    ...
    return {
        "schema": "citysim.play-101.residential-l01-v1.build.v1",
