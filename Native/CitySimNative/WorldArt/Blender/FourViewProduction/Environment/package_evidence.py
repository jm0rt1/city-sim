...
def main():
    for a in ("axis_civic_road","pocket_grove_park"): manifest(a,sheet(a))
    preview=HERE/"preview"/"environment_streetscape_preview_camNE.png"
    data={"schema":"citysim.world-art.environment-preview.v1","status":"source-only-review-evidence-not-live","layout":{"roadTileCenter":[0,0,0],"parkTileCenter":[0,2,0],"tileSize":2.0,"axes":"shared-world-XY"},"artifacts":[]}
