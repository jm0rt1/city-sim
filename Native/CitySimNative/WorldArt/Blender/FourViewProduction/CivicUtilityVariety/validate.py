#!/usr/bin/env python3
"""Validate CitySim CivicUtilityVariety sources and deterministic renders."""
...
def main():
    ...
    results = {
        "schema": "citysim.world-art.civic-utility-variety-validation.v1",
        "status": "PASS",
        "blenderVersion": actual,
        "assets": {},
    }
    with tempfile.TemporaryDirectory(prefix="citysim-civic-utility-variety-") as temp_dir:
    ...
    report = "CIVIC_UTILITY_VARIETY_VALIDATION_PASS\n" + json.dumps(results, indent=2, sort_keys=True) + "\n"
