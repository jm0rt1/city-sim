...
- **Current disposition:** Offline calibration v03 is frozen at world-art commit `6380037d42ede73eca60aac4a9b1c7b710f681d6` and independently accepted at 25/28, improving from v02's retained 18/28 rejection. All binding CONTRACT-010/011 calibration requirements pass: four grounded/readable frontages at exact native-2x scale, unique directional geometry and hashes, preserved grayscale hierarchy, normalized-alpha edges with zero magenta spill, and repeatable raw/normalized output. Integration authorizes the next controlled source slice: Residential L2–L4 variant-zero N/E/S/W (12 sources), with materially different massing and no inheritance of L1's broad dark roof as a family-wide silhouette. Commercial/industrial expansion, production selection, and renderer ingestion remain blocked pending independent review of that residential slice.
