...
- **Status:** Active. Residential L1–L4, Commercial L1–L4, Industrial L1, and Industrial L2 have accepted source and shipping outcomes. Industrial L3 source authority is complete; replacement-R2 renderer ingestion is active and production selection remains pending staged and independent QA. Industrial L4 retains its full rejection trail and exact v16 A-only raw return. Exact v17 North pre-pixel repair `46b1c584dd6769356b716fd881bef681167d5f00` passed independent Renderer and QA review.
- **Latest L4 disposition:** Integration authorizes exactly one A-only v17 North native raw probe under `docs/production/evidence/PLAY-027/INDUSTRIAL-L04-CRUCIBLE-GANTRY-V17-NORTH-RAW-PROBE-AUTHORITY.md`. The exact descriptor, geometry, material, sampling, orientation, and authorship state are fail-closed with one positive and 20 negative resolver cases. World Art must stop after the A-only packet. B/C, East/South/West, normalization, ingestion, shipping, and production selection remain unauthorized.
